...
export default class LoginApp extends Component {
    ...
    async loginFromTables({ correo, password }) {
        ...
        const url = `${this.SUPABASE_URL}/rest/v1/usuario?correo=eq.${encodeURIComponent(correo)}&contrasena=eq.${encodeURIComponent(password)}&select=correo,nombre_usuario`;
            ...
            <div className="app-container">
                <div className="login-card">
                    ...
                    <div className="form-section">
                        ...
                        {message && (
                            <div
                                className={`message ${message.includes("exitoso") || message.includes("creada")
                                        ? "message-success"
                                        : "message-error"
                                    }`}
                            >
